...
// // Pour indiquer que c'est un Observale on met souvent $ a la fin
// // Il prend en parametre une fonction qui elle meme prend un objet Observer
// // Cet Observer comporte des methodes importante comme next, error, complete
// let values$ = Observable.create((observer) => {
//     // Methode next permet de pousser les données
//     // Une fonction retourne q'une seule valeur
//     // Un observer peut pousser des valeurs supplementaire
//     observer.next("Hello");
//     observer.next("World");

//     // Un observer peut pousser de manière asynchrone
//     setTimeout(() => {
...
//         throw Error("Boom");
//         // on appelle la methode complete pour passer la main a un autre observable
//         observer.complete();
//     } catch (e) {
...
// // La methode subscribe prend 3 handlers (callback) en paramètre
// values$.subscribe(
...
// // Interval: si on produit des valeurs numerique qui s'incrémente toute les secondes 
...
// // Do: permet d'informer sur une valeur à l'instant t (pas de transformation de données)
// // pas mal pour debuguer
// let phrase = "Enjoy this trainig";
